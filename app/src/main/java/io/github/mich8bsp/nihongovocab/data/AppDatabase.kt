...
@Database(entities = [Entry::class, PoolState::class], version = 3, exportSchema = false)
...
abstract class AppDatabase : RoomDatabase() {
    ...
    companion object {
        ...
        // Adds Entry.comment - free-text notes field, e.g. for My Vocabulary words.
        private val MIGRATION_2_3 = object : Migration(2, 3) {
            override fun migrate(db: SupportSQLiteDatabase) {
                db.execSQL("ALTER TABLE entries ADD COLUMN comment TEXT NOT NULL DEFAULT ''")
            }
        }
